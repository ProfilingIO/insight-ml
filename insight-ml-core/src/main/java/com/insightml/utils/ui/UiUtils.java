...
public final class UiUtils {
	...
	public static String toString(final Map<?, ?> map, final boolean multiLine, final boolean formatValues) {
	...
	public static String format(final DiscreteDistribution<?> object, final double min) {
		return toString(Collections.getTopN(((DiscreteDistribution<?>) object).getMap(), 9999999, min), true, true);
	}
